...
_OFFICIAL_DOCS_PRICING: Dict[tuple[str, str], PricingEntry] = {
    ...
    # P121/MOL-455: DeepSeek V4 generation. v4-pro reflects the 75% discount
    # window through 2026-05-31; bump pricing_version when the discount expires
    # (post-discount: $1.74 input / $3.48 output per million). v4-flash has no
    # announced discount expiry.
    (
        "deepseek",
        "deepseek-v4-pro",
    ): PricingEntry(
        ...
        source="official_docs_snapshot",
        source_url="https://api-docs.deepseek.com/quick_start/pricing",
        pricing_version="deepseek-pricing-2026-05-08-v4-discount",
    ),
    (
        "deepseek",
        "deepseek-v4-flash",
        ...
        source="official_docs_snapshot",
        source_url="https://api-docs.deepseek.com/quick_start/pricing",
        pricing_version="deepseek-pricing-2026-05-08-v4",
    ),
    # Google Gemini
    (
        "google",
