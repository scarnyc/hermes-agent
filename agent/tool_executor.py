    ...
    for i, (tc, name, args, block_result, blocked_by_guardrail) in enumerate(parsed_calls):
        ...
        if r is None:
            ...
            if is_error:
                ...
                # P33/MOL-525 + MOL-220: record on the agent-level accumulator
                # so cron's run_job can surface the failure when final_response
                # is empty (see mol245_silent_miss_architecture).
                agent._record_tool_error(function_name, result_preview, function_args)
